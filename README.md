"Public Transport Route Finder System (PTRFS) provides data about some routes between starting point taken from user and arrival point which user would like to go. 
